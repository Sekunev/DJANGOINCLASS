  ...
  return (
    <div className="flex justify-center items-center">
      <div className="bg-gray-500 p-10 rounded-lg shadow-md">
        <h1 className="text-gray-100 text-xl font-bold">{item.brand}</h1>
        <div className="mt-4 mb-10">
          <p className="text-gray-200">{item.amount}</p>
        ...
        <h3 className="text-xs text-gray-200 uppercase">{item.name}</h3>
        <button
